        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-control" required placeholder="Телефон" value="{{$phone->phone}}"> 
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    @if($firms)
                        ...
                        @if($firm->id == $phone->firm_id)
                        <option selected value="{{$firm->id}}">{{$firm->name}} (ID: {{$firm->id}})</option>
                        @else
