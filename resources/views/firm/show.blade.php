...
<div id="layoutSidenav_content">
   ...
   <div class="row">
        ...
        <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('firms.index') }}" title="К списку"> <i class="fas fa-backward "></i> </a>
            </div>
            <div class="pull-left">
        ...
        <div class="card mb-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Наименование: {{$firm->name}}</strong>
                    <p></p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Создана: {{$firm->created_at}}</strong>
                    <p></p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Изменена: {{$firm->updated_at}}</strong>
                    <p></p>
                </div>
            </div>
            @if(isset($firm->phones) && $firm->phones)
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Телефоны ({{count($firm->phones->pluck('phone')->toArray())}}): </strong>
                    <p>{{ implode(', ',$firm->phones->pluck('phone')->toArray()) }}</p>
            </div>
            </div>
            @endif
                            </div>
